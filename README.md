# example-common-lisp-project

an example common lisp project
...
Hello [name] from example-common-lisp-project
```
...
Your users can install the script with `uname/example-common-lisp-project`.
